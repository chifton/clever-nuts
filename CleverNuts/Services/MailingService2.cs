...
namespace CleverNuts.Services
{
    public class MailingService2
    {
        ...
        private const string SmtpServerPassword = "tepbjnyseicxmnqc";
        ...
        public void SendTokenByEmail(string token, string recipient, string username)
        {
            ...
            message.Subject = "Clever Nuts / Account activation";

            const string template = @"<html>
                                    <body>
                                     <h2>Hello nutter,</h2>
                                     <p>Click on this link to activate your account and save squirrels !</p>
                                     <p><a href=""{0}"">{0}</a></p>
                                     <p>Chift</p>
                                    </body>
                                   </html>";
            ...
            var url = String.Format("{0}account/registerconfirmation/?Id={1}", SitewebUrl, token);
