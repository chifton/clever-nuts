...
<asp:Content ID="indexContent" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <script type="text/javascript">
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    var url1 = "/Play/nom1";
                    var url2 = "/Play/nom2";
                    var url3 = "/Play/score1";
                    var url4 = "/Play/score2";
                    var url5 = "/Play/scorebonus1";
                    var url6 = "/Play/scorebonus2";
                    console1.textContent = "It's your turn !";
                    $.get(url1, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data1) {
                        panel1.textContent = data1;
                        me1 = data1;
                        playor1 = data1;
                    });
                    $.get(url2, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data2) {
                        panel2.textContent = data2;
                        me2 = data2;
                        playor2 = data2;
                    });
                    $.get(url3, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data3) {
                        panel1.textContent = me1 + " : " + data3 + " nuts";
                        playorscore1 = data3;
                    });
                    $.get(url4, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data4) {
                        panel2.textContent = me2 + " : " + data4 + " nuts";
                        playorscore2 = data4;
                    });
                    $.get(url5, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data5) {
                        panel3.textContent = "Bonus : " + data5;
                        playorscorebonus1 = data5;
                    });
                    $.get(url6, { jouant: "KO", codepartiejeu: $("#tonGroupe").val() }, function (data6) {
                    ...
                    var myVar = setInterval(function () {
                        ...
                        var url3end = "/Play/score1";
                        var url4end = "/Play/score2";
                        ...
                        $.get(url3end, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data3) {
                            playorscore1end = data3;
                        });
                        $.get(url4end, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data4) {
                        ...
                        if (sommeawale1 == 0 || sommeawale2 == 0) {
                            ...
                            var urlend = "/Play/EndGame";
                            $.get(urlend, { idMoi: $("#tonGroupe").val(), position: $("#order").val(), score1fin: scorefinal1, score2fin: scorefinal2 }, function (datareturnend) {
                                console.log("Oyé");
                                // ICI
                    ...
                    // SUR UN TROU
                    $(function () {
                        serveurdejeu = $.connection.gameserver;
                        ...
                        serveurdejeu.client.jouerawale = function (p) {
                            ...
                            var url = "/Play/Sequence";
                            var lettre = retourneLettre(p);
                            $.get(url, { possible: lettre, codepartiejeu: $("#tonGroupe").val() }, function (data) {
                                ...
                                if (data == "OK") {
                                    ...
                                    setTimeout(function () {
                                            ...
                                            if (trou >= 0 && trou < 6) {
                                                ...
                                                for (var o = trou; o >= 0; o--) {
                                                    if (label[o].childElementCount != 2 && label[o].childElementCount != 3) {
                                                        ...
                                                        bouffeur = label[o].childElementCount;
                                                        console.log("Il y a en noix" + bouffeur);
                                                        console.log("Bouffe !");
                                                        for (var f = 0; f < bouffeur; f++) {
                                                            tablebouffe.appendChild(label[o].firstChild);
                                                            if (tablebouffe.childElementCount < 10) {
                                        ...
                                        $.get(url1, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data1) {
                                            panel1.textContent = data1;
                                            me1 = data1;
                                            playor1 = data1;
                                            $('input#nom1vrai').val(data1);
                                        });
                                        $.get(url2, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data2) {
                                            panel2.textContent = data2;
                                            me2 = data2;
                                            playor2 = data2;
                                            $('input#nom2vrai').val(data2);
                                        });
                                        $.get(url3, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data3) {
                                            panel1.textContent = me1 + " : " + data3 + " nuts";
                                            playorscore1 = data3;
                                            $('input#score1vrai').val(data3);
                                        });
                                        $.get(url4, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data4) {
                                            panel2.textContent = me2 + " : " + data4 + " nuts";
                                            playorscore2 = data4;
                                            $('input#score2vrai').val(data4);
                                        });
                                        $.get(url5, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data5) {
                                            panel3.textContent = "Bonus : " + data5;
                                            playorscorebonus1 = data5;
                                        });
                                        $.get(url6, { jouant: "OK", codepartiejeu: $("#tonGroupe").val() }, function (data6) {
                                            panel4.textContent = "Bonus : " + data6;
                                            playorscorebonus2 = data6;
                                        });
                        ...
                        var url10 = "/Play/bonArgument";
                        $.get(url10, { codepartiejeu: $("#tonGroupe").val() }, function (data10) {
                        ...
                        serveurdejeu.client.demanderInfos = function () {
                            // On récupère ici d'abord les id et username
                            // ON VA APRES DIFFERENCIER LES USERS ET LES ANONYMOUS
                            var urluseranonymous = "/Play/checkUserOrAnonymous";
                            $.get(urluseranonymous, null, function (datauseranonymmous) {

                                //alert(datauseranonymmous);

                                // Cas des anonymous : on demande leur username
                                if (datauseranonymmous == "anonym") {
                                    jPrompt('', 'Your nutter name !', 'Enter your username to play !', function (r) {
                                        // L'utilisateur a rentré son username
                                        if (r) {
                                            // On appelle le serveur pour la suite de la mise à jour
                                            nomdemonjoueur = r;
                                            // La connection est sensée être déjà établie au hub
                                            // On lui attribue automatiquement alors un joueur déjà en ligne
                                            // Create a function that the hub can call back to display messages.

                                            serveurdejeu.state.joueurNom = nomdemonjoueur;
                                            serveurdejeu.server.receiveUsername();

                                            // On intialise cette variable pour empecher
                                            // boucle recherche joueur
                                            receveurContinueCherche = true;

                                            // On initialise la variable ici pour rediriger en page d'accueil s'il n'y a pas de joueurs
                                            pasDeJoueursTrouves = true;

                                            // Messages de patientement dans les consoles
                                            $("#consoleJoueur1").text("Checking nutters...");
                                            $("#consoleJoueur2").text("Checking nutters...");
                                            $("#consoleJoueur1").blink();
                                            $("#consoleJoueur2").blink();

                                            // On redirige vers la page d'accueil s'il n'y a pas de joueurs avec qui jouer
                                            redirectSiPasDeJoueurs = setTimeout(function () {
                                                jConfirm("All nutters online are already playing !\nDo you want to play against Delmagon (Yes) or come back later (No) ?", "Delmagon or come back ?", function (r2) {
                                                    if (r2) {
                                                        $.connection.hub.stop();  // Arrête la connection au hub
                                                        location.href = "/PlayDelmagon/Index?joueurdelmagon=" + nomdemonjoueur;
                                                    }
                                                    else {
                                                        $.connection.hub.stop();  // Arrête la connection au hub
                                                        location.href = '<%= Page.ResolveUrl("~/Home/Index") %>';
                                ...
                                else if (datauseranonymmous == "user") {

                                    // Traitement des users ici
                                    var urlnutter = "/Play/getNutterUser";
                                    $.get(urlnutter, null, function (datanutter) {

                                        // Récupération du nom du nutter user
                                        nomdemonjoueur = datanutter;
                                ...
                                else if (datauseranonymmous == "facebook") {

                                    // Traitement des facebookers ici
                                    var urlnutter = "/Play/getNutterUserFacebook";
                                    $.get(urlnutter, null, function (datanutter) {
                        ...
                        // Fonction pour contrôler quand le joueur n'a pas d'aversaire, mais clique quand même sur les trous
                        serveurdejeu.client.pasPossibleDeJouer = function () {
                            jAlert("No nutter against you again ! Wait", "Can't play !");
                        };
                        ...
                        // Fonction pour contrôler si l'adversaire joue déjà ou pas
                        // Tout ça permet de limiter l'appel au serveur
                        serveurdejeu.client.identifierAdversaire = function () {
                            // On controle chaque 3s que le joueur n'a pas été contécté
                            // pour éviter les appels répétifis au serveur
                            continueoupas = setTimeout(function () {
                                if (receveurContinueCherche == true) {
                                    var joueuradversaireId = aleatoireJoueurId(0, nbJoueursEnLigne - 1);
                                    serveurdejeu.server.jouetil(joueuradversaireId);
                                    console.log("Checking for available online nutter !");
                                }
                            }, 1000);
                        };
                        ...
                        serveurdejeu.client.returnNameJavascript = function (jeujoueuradversaire, tongroupeserver) {
                            // On a trouvé un joueur, donc on détruit le setTimeOut d'avant pour aller à l'accueil
                            clearTimeout(redirectSiPasDeJoueurs);
                        ...
                        serveurdejeu.client.miseAjourJeuAdversaire = function (nomcaller, tongroupeserver2) {
                            // Un nutter veut jouer avec moi, donc on détruit le setTimeOut d'avant pour aller à l'accueil
                            clearTimeout(redirectSiPasDeJoueurs);

                            // On empêche ici d'autres demandes de nutters en ligne
                            // Pour stopper Checking for available,nutters online
                            receveurContinueCherche = false;
                            clearTimeout(continueoupas);
                            ...
                            $('#sendmessage').click(function () {
                                if (peutChatter == 1) {
                                    if ($("#message").val()) {
                                        ...
                                        serveurdejeu.server.sendChat(nomdemonjoueur, $('#message').val(), $('#tonGroupe').val());
